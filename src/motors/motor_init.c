...
gpio_adc_t ADCmotor[2][2] = {
    ...
    { GPIO_ADC(A, 0, AD1PCFGL, 0,              0, ADC_BUFF_PIN),
      GPIO_ADC(A, 1, AD1PCFGL, 1,   ADC_BUFF_PIN, ADC_BUFF_PIN)},
    // Current and Voltage Motor 1
    { GPIO_ADC(B, 0, AD1PCFGL, 2, 2*ADC_BUFF_PIN, ADC_BUFF_PIN),
      GPIO_ADC(B, 1, AD1PCFGL, 3, 3*ADC_BUFF_PIN, ADC_BUFF_PIN)},
};

QEI_t QEIMotor[2] = {
    MOTOR_QEI_INIT(POS1CNT, QEI1CON, 8),
    MOTOR_QEI_INIT(POS2CNT, QEI2CON, 8)
};
