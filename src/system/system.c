...
void InitQEI1(void) {
    ...
    QEI1CONbits.SWPAB = (get_motor_parameters(MOTOR_ZERO).versus >= 1) ? 1 : 0; // Phase A and Phase B inputs swapped
...
void InitQEI2(void) {
    ...
    QEI2CONbits.SWPAB = (get_motor_parameters(MOTOR_ONE).versus >= 1) ? 1 : 0; // Phase A and Phase B inputs swapped
