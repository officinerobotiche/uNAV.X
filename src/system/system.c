...
void InitQEI1(void) {
    ...
    QEI1CONbits.SWPAB = parameter_motor_left.versus; // Phase A and Phase B inputs swapped
...
void InitQEI2(void) {
    ...
    QEI2CONbits.SWPAB = parameter_motor_right.versus; // Phase A and Phase B inputs swapped
